      ...
      >
        ...
        <div id="CheckoutProgressGrid" className="sc-jFmBXp kkNjpY">
          <div id="addressSection AccordionParent" className="sc-cfQIsQ dNczxK">
            <div
              id="addressSection AccordionButton"
            ...
            <div
              ...
              className="sc-bJYTlW gPqmkd"
            >
              <div id="ExpandedSection" className="sc-gelMue fOcJJx">
                <div
                  id="ShippingAddressFormContainer"
                  className="sc-eyLAWx eTwXdx"
                >
                  <div
                    id="AddressOptionMainContainer"
                    className="sc-hINMOq goquha"
                  >
                    <div id="AddressOptionWrapper" className="sc-jowtIB cefdzy">
                      ...
                      <div
                        id="AddressLinesContainer"
                        className="sc-kkCwLU gyFtwX"
                      >
                        <h4
                          id="SmallBodyText"
                          fontWeight={400}
                    ...
                    >
                      <h4
                        id="DefaultAddressIndicator"
                        className="sc-cTcUcm lbAmQQ"
                      >
                        DEFAULT
                      </h4>
                    </div>
          ...
          <div
            ...
            disabled
            className="sc-cfQIsQ fpRzFz"
          >
            <div
              id="shippingMethodSection AccordionButton"
              disabled
              className="sc-jDfIjF hBagAJ"
            >
              <button
                id="OrderPlacedPageGridCell"
                className="sc-hQIyOC kAUeou"
                disabled
              >
                <div id="SummarisedSection" className="sc-hgRfpC foWCkQ">
                  <div id="SectionLeftContainer" className="sc-fiSPbx khYJsg">
            ...
            >
              <div id="ExpandedSection" className="sc-gelMue fOcJJx">
                <div
                  id="ShippingMethodFormContainer"
                  className="sc-keVmGr goUNDP"
                >
                  <div
                    id="ShippingMethodsSelectionContainer"
                    className="sc-eMOcrC deHcmp"
                  >
                    <div
                      id="DeliveryMethodsAccordionSummaryContainer"
                      className="sc-fekXMp eIrCCv"
                    >
                      <div
                        id="ShippingMethodsContainer"
                        className="sc-lbzwWw rNntD"
                      />
                    </div>
                  </div>
                </div>
