    ...
    <div>
      ...
      >
        <div
          ...
          className="sc-fccqeR eXPQdv"
        >
          <div
            id="PersonalInformationFormContainer"
            className="sc-eqZCwh evZlXa"
          >
            <h4 id="HeaderText" className="sc-flxzLh lapQuH">
              Email
            </h4>
            <span id="Marginer" className="sc-lnskGP epXBuZ" />
            <div
              id="PersonalInformationFormRow"
              className="sc-eFzoVY jIImoU row"
            >
              <input
                placeholder="Email"
                disabled=""
                readOnly=""
                id="FormInput"
                className="sc-fopvND eEKggt form-control"
            ...
            <div
              id="PersonalInformationFormRow"
              className="sc-eFzoVY bRGWiM row"
            >
              <h4 id="HeaderText" className="sc-flxzLh lapQuH">
                First Name
              </h4>
              <span id="Marginer" className="sc-lnskGP emuvFR" />
              <input
              ...
              <div className="PhoneInputPersonalInformationForm PhoneInput">
                <div className="PhoneInputCountry">
                  <select
                    ...
                    style={{ marginLeft: 10, height: 45, zIndex: 1000 }}
                  >
                ...
                <input
                  ...
                  style={{ height: 45, appearance: "none" }}
                />
              </div>
            </div>
          </div>
